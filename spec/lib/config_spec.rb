...
describe Config do
  let(:config) { described_class.from(env) }
    ...
    context 'when using valid environment variables' do
      ...
      it 'matches the environment variables for MQTT topics' do
        expect(config.mappings).to eq(
          [
            { topic: 'senec/0/ENERGY/GUI_INVERTER_POWER', measurement: 'PV', field: 'inverter_power' },
            { topic: 'senec/0/ENERGY/GUI_HOUSE_POW', measurement: 'PV', field: 'house_power' },
            { topic: 'senec/0/ENERGY/GUI_GRID_POW', measurement_positive: 'PV', measurement_negative: 'PV',
              field_positive: 'grid_import_power', field_negative: 'grid_export_power', },
            { topic: 'senec/0/PV1/POWER_RATIO', measurement: 'PV', field: 'grid_export_limit' },
            { topic: 'senec/0/ENERGY/GUI_BAT_DATA_POWER', measurement_positive: 'PV', measurement_negative: 'PV',
              field_positive: 'battery_charging_power', field_negative: 'battery_discharging_power', },
            { topic: 'senec/0/ENERGY/GUI_BAT_DATA_FUEL_CHARGE', measurement: 'PV', field: 'battery_soc' },
            { topic: 'senec/0/WALLBOX/APPARENT_CHARGING_POWER/0', measurement: 'PV', field: 'wallbox_power' },
            { topic: 'somewhere/HEATPUMP/POWER', measurement: 'HEATPUMP', field: 'power' },
            { topic: 'senec/0/TEMPMEASURE/CASE_TEMP', measurement: 'PV', field: 'case_temp' },
            { topic: 'senec/0/ENERGY/STAT_STATE_Text', measurement: 'PV', field: 'system_status' },
          ],
        )
      end
    end
      ...
      it 'builds mappings' do
        expect(config.mappings).to eq(
          [
            ...
            { topic: 'senec/0/ENERGY/GUI_BAT_DATA_FUEL_CHARGE', measurement: 'PV', field: 'bat_fuel_charge' },
            ...
            { topic: 'senec/0/TEMPMEASURE/CASE_TEMP', measurement: 'PV', field: 'case_temp' },
            { topic: 'senec/0/ENERGY/STAT_STATE_Text', measurement: 'PV', field: 'current_state' },
            { topic: 'senec/0/PV1/MPP_POWER/0', measurement: 'PV', field: 'mpp1_power' },
            { topic: 'senec/0/PV1/MPP_POWER/1', measurement: 'PV', field: 'mpp2_power' },
            { topic: 'senec/0/PV1/MPP_POWER/2', measurement: 'PV', field: 'mpp3_power' },
            { topic: 'senec/0/ENERGY/GUI_INVERTER_POWER', measurement: 'PV', field: 'inverter_power' },
            { topic: 'senec/0/WALLBOX/APPARENT_CHARGING_POWER/0', measurement: 'PV', field: 'wallbox_charge_power' },
            { topic: 'somewhere/HEATPUMP/POWER', measurement: 'PV', field: 'heatpump_power' },
          ],
        )
      end
    end
