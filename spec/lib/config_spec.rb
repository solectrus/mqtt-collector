    ...
    context 'when using valid environment variables' do
      ...
      it 'matches the environment variables for MQTT topics' do
        expect(config.mappings).to eq(
          [
            { topic: 'senec/0/ENERGY/GUI_INVERTER_POWER', measurement: 'PV', field: 'inverter_power', type: 'integer' },
            { topic: 'senec/0/ENERGY/GUI_HOUSE_POW', measurement: 'PV', field: 'house_power', type: 'integer' },
            { topic: 'senec/0/ENERGY/GUI_GRID_POW', measurement_positive: 'PV', measurement_negative: 'PV',
              field_positive: 'grid_import_power', field_negative: 'grid_export_power', type: 'integer', },
            { topic: 'senec/0/PV1/POWER_RATIO', measurement: 'PV', field: 'grid_export_limit', type: 'integer' },
            { topic: 'senec/0/ENERGY/GUI_BAT_DATA_POWER', measurement_positive: 'PV', measurement_negative: 'PV',
              field_positive: 'battery_charging_power', field_negative: 'battery_discharging_power', type: 'integer', },
            { topic: 'senec/0/ENERGY/GUI_BAT_DATA_FUEL_CHARGE', measurement: 'PV', field: 'battery_soc', type: 'float' },
            { topic: 'senec/0/WALLBOX/APPARENT_CHARGING_POWER/0', measurement: 'PV', field: 'wallbox_power', type: 'integer' },
            { topic: 'somewhere/HEATPUMP/POWER', measurement: 'HEATPUMP', field: 'power', type: 'integer' },
            { topic: 'senec/0/TEMPMEASURE/CASE_TEMP', measurement: 'PV', field: 'case_temp', type: 'float' },
            { topic: 'senec/0/ENERGY/STAT_STATE_Text', measurement: 'PV', field: 'system_status', type: 'string' },
          ],
        )
      end
    end
        ...
        expect(config.mappings).to eq(
          [
            ...
            { topic: 'senec/0/ENERGY/GUI_BAT_DATA_POWER',
              ...
              type: 'integer', },
            { topic: 'senec/0/TEMPMEASURE/CASE_TEMP', measurement: 'PV', field: 'case_temp', type: 'float' },
            { topic: 'senec/0/ENERGY/STAT_STATE_Text', measurement: 'PV', field: 'current_state', type: 'string' },
            { topic: 'senec/0/PV1/MPP_POWER/0', measurement: 'PV', field: 'mpp1_power', type: 'integer' },
            { topic: 'senec/0/PV1/MPP_POWER/1', measurement: 'PV', field: 'mpp2_power', type: 'integer' },
            { topic: 'senec/0/PV1/MPP_POWER/2', measurement: 'PV', field: 'mpp3_power', type: 'integer' },
            { topic: 'senec/0/ENERGY/GUI_INVERTER_POWER', measurement: 'PV', field: 'inverter_power', type: 'integer' },
            { topic: 'senec/0/PV1/POWER_RATIO', measurement: 'PV', field: 'power_ratio', type: 'integer' },
            { topic: 'senec/0/WALLBOX/APPARENT_CHARGING_POWER/0',
              measurement: 'PV',
              field: 'wallbox_charge_power', type: 'integer', },
            { topic: 'senec/0/WALLBOX/APPARENT_CHARGING_POWER/1',
              measurement: 'PV',
              field: 'wallbox_charge_power1', type: 'integer', },
            { topic: 'senec/0/WALLBOX/APPARENT_CHARGING_POWER/2',
              measurement: 'PV',
              field: 'wallbox_charge_power2', type: 'integer', },
            { topic: 'senec/0/WALLBOX/APPARENT_CHARGING_POWER/3',
              measurement: 'PV',
              field: 'wallbox_charge_power3', type: 'integer', },
            { topic: 'somewhere/HEATPUMP/POWER', measurement: 'PV', field: 'heatpump_power', type: 'integer' },
          ],
        )
      end
    end
        ...
        expect(config.mappings).to eq(
          [
            ...
            { topic: 'senec/0/PV1/POWER_RATIO',
              measurement: 'PV',
              field: 'power_ratio', type: 'integer', },
            { topic: 'senec/0/WALLBOX/APPARENT_CHARGING_POWER/0',
              measurement: 'PV',
              field: 'wallbox_charge_power', type: 'integer', },
            { topic: 'senec/0/WALLBOX/APPARENT_CHARGING_POWER/1',
